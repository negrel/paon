...
func NeedRenderListener(handler func(NeedRenderEvent)) (events.Type, events.Listener) {
	return NeedRenderEventType(), events.ListenerFunc(func(event events.Event) {
