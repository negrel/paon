...
func (vb *VBox) AppendChild(child pdkwidgets.Widget) error {
	err := vb.BaseLayout.AppendChild(child)
	if err != nil {
		vb.flags = render.DrawFlag | render.LayoutFlag
	}
...
func (vb *VBox) InsertBefore(reference, child pdkwidgets.Widget) error {
	err := vb.BaseLayout.InsertBefore(reference, child)
	if err != nil {
		vb.flags = render.DrawFlag | render.LayoutFlag
	}
...
func (vb *VBox) RemoveChild(child pdkwidgets.Widget) error {
	err := vb.BaseLayout.RemoveChild(child)
	if err != nil {
		vb.flags = render.DrawFlag | render.LayoutFlag
	}
